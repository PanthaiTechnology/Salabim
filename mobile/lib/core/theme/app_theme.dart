...
class AppColors {
  ...
  static const Color secondary = Color(0xFFFF4D8D); // rosa de destaque (modo "hum")
  static const Color accentListen = Color(0xFF7C4DFF);
  static const Color accentHum = Color(0xFFFF4D8D);
  ...
  static const LinearGradient humGradient = LinearGradient(
    colors: [Color(0xFFFF4D8D), Color(0xFFFF8A4D)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );
}
